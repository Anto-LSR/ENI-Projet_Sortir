 ...
 */
final class Version20220405111620 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD photo VARCHAR(255) DEFAULT NULL, CHANGE roles roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', CHANGE administrateur administrateur TINYINT(1) DEFAULT false, CHANGE actif actif TINYINT(1) DEFAULT true');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant DROP photo, CHANGE roles roles LONGTEXT NOT NULL COLLATE `utf8mb4_bin`, CHANGE administrateur administrateur TINYINT(1) DEFAULT 0, CHANGE actif actif TINYINT(1) DEFAULT 1');
    }
}
